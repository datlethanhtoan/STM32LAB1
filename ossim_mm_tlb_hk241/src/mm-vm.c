...
int __free(struct pcb_t *caller, int vmaid, int rgid)
{
	...
	struct vm_rg_struct *tmp = get_symrg_byid(caller->mm, rgid);
	rgnode.rg_start = tmp->rg_start;
	rgnode.rg_end = tmp->rg_end;
...
int pg_getpage(struct mm_struct *mm, int pgn, int *fpn, struct pcb_t *caller)
{
	...
	{ /* Page is not online, make it actively living */
		...
		/* Update page table */
		pte_set_swap(&vicpte, PAGING_PTE_SWPTYP_LOBIT, swpfpn); 
